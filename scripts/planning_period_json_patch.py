...
# Inserito dopo le funzioni originali: le sovrascrive senza usare re.sub come replacement.
# Così evitiamo l'errore Python: re.error bad escape \d.
NEW_JS = r'''
...
def patch_html(html: str) -> str:
    ...
    if 'function assignSmart(' not in html and marker in html:
        html = html.replace(marker, NEW_JS.strip() + "\n\n" + marker, 1)
        changed = True
