...
function unlockGrabCloud(){if(typeof showTelepassLogin==='function'){showTelepassLogin(true);return true;}alert('Login non disponibile: ricarica la pagina.');return false;}
function lockGrabCloud(){if(typeof telepassLogout==='function')telepassLogout();else{localStorage.removeItem('telepassCloudSession');localStorage.removeItem('telepassCloudUser');location.reload();}}
