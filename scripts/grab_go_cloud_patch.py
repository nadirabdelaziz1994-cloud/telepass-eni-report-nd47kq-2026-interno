...
function grabAdminUnlocked(){return true;}
async function unlockGrabCloud(){alert('Sei già dentro: il login del sito vale anche per Grab & Go.');return true;}
function lockGrabCloud(){alert('Per uscire chiudi il browser oppure cancella le credenziali salvate del sito.');}
