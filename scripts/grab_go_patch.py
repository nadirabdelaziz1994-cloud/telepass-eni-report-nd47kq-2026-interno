...
CSS = """
.grab-filters{margin-bottom:10px}.grab-agent-card{margin-top:12px}.grab-table{min-width:1120px}.grab-table select{width:150px;padding:7px;border-radius:10px;border:1px solid var(--line);background:#fff}.grab-green{box-shadow:inset 5px 0 0 var(--green)}.grab-red{box-shadow:inset 5px 0 0 var(--red)}.grab-yellow{box-shadow:inset 5px 0 0 #d6a500}.grab-dot{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:50%;background:#0f2746;color:#fff;font-weight:900}
"""
