...
def main():
    ...
    try:
        from planning_overflow_holidays_patch import main as overflow_holidays_main
        overflow_holidays_main()
    except Exception as exc:
        raise RuntimeError(f"Errore overflow/ferie planning: {exc}") from exc
